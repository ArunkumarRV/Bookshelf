...
body{
 background-image: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("images/boook.jpg"); background-repeat: no-repeat;
...
<input type="number" name="tid" placeholder="Enter track id" requierd>
